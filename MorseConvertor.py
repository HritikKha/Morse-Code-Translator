...
if __name__ == "__main__":
    ...
    headlabel = Label(root, text='Welcome to Morse Code Translator', fg='black', bg="light grey")

    # Create a "One Language " label
    label1 = Label(root, text="One Language ", fg='black', bg='light cyan')

    # Create a "From Language " label
    label2 = Label(root, text="From Language", fg='black', bg='light cyan')

    # Create a "To Language " label
    label3 = Label(root, text="To Language ", fg='black', bg='light cyan')

    # Create a "Converted Language " label
    label4 = Label(root, text="Converted Language ", fg='black', bg='light cyan')
    ...
    language1_field = Text(root, height=5, width=30, font="lucida 13")
    language2_field = Text(root, height=5, width=30, font="lucida 13")

    # padx keyword argument used to set padding along x-axis .
    language1_field.grid(row=1, column=1, padx=10, pady=10)
    language2_field.grid(row=5, column=1, padx=10, pady=10)
    ...
    FromLanguage_option.grid(row=2, column=1, padx=10, pady=10)
    ToLanguage_option.grid(row=3, column=1, ipadx=10, pady=10)
